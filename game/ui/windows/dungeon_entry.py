...
class DungeonEntryWindow(BaseWindow):
    ...
    def render(self):
        ...
        # Заголовок
        title_height = self.scaler.scale_height(40)
        ...
        content_y += self.scaler.scale_height(10)
        ...
        # Опции меню
        content_y += self.scaler.scale_height(15)
...
class DungeonExitWindow(BaseWindow):
    ...
    def render(self):
        ...
        # Вопрос
        content_y = win_y + title_height + self.scaler.scale_height(20)
        line_height = self.scaler.scale_height(25)
        padding_x = self.scaler.scale_width(20)
        ...
        content_y += line_height + self.scaler.scale_height(15)
