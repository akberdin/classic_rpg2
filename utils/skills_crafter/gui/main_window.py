...
class SkillsCrafterApp:
    ...
    def _collect_skill_data(self) -> SkillData:
        ...
        skill.visuals = VisualData(
            ...
            animation_vertical_offset=display_data.get("animation_vertical_offset", 0.0),
            random_frame_order=display_data.get("random_frame_order", False),
            display_type=display_data.get("display_type", "on_target"),
            anchor_point=display_data.get("anchor_point", "center"),
            face_target=display_data.get("face_target", False),
            sprite_rotation_offset=display_data.get("sprite_rotation_offset", 0.0),
